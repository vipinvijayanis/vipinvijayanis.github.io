...
- Use the system sans-serif stack. Do not require external font downloads.
...
- Left: `Vipin Vijayan`, linked to the portfolio root.
- Right: only the essential links—Work, Résumé and Contact.
